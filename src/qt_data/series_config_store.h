...
namespace ksv::qt_data {
    ...
    private:
        ...
        void writeLocked(const std::vector<application::SeriesConfig> &, std::optional<application::SeriesId> next,
                         const std::vector<application::AxisConfig> &,
                         std::optional<application::AxisId> nextAxisId) const;
        ...
        mutable std::optional<std::tuple<
            std::vector<application::SeriesConfig>,
            std::optional<application::SeriesId>,
            std::vector<application::AxisConfig>,
            std::optional<application::AxisId> > > m_draftBaseline;

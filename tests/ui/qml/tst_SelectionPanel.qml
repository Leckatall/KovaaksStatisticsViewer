...
TestCase {
    ...
    function test_currentRunIsHighlightedAcrossListsAndUpdates() {
        ...
        compare(findChild(recentCurrent, "runSelectionAccent_0").visible, true)
        compare(findChild(recentNext, "runSelectionAccent_1").visible, false)
        ...
        compare(findChild(recentCurrent, "runSelectionAccent_0").visible, false)
        compare(findChild(scenarioNext, "runSelectionAccent_1").visible, true)
    }
